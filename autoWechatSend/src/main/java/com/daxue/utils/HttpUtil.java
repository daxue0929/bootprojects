...
public class HttpUtil {
    ...
    public static String get(String url){
        return request(url,"GET",null,null,CONTENT_TYPE_FORM);
    }

    public static String get(String url,Map<String,Object> params ){
        return request(url,"GET",params,null,CONTENT_TYPE_FORM);
    }

    public static String post(String url){
        return request(url,"POST",null,null,CONTENT_TYPE_FORM);
    }

    public static String post(String url,Map<String,Object> params ){
        return request(url,"POST",params,null,CONTENT_TYPE_FORM);
    }

    public static String post(String url,Map<String,Object> params,Map<String,String> headers ){
        return request(url,"POST",params,headers,CONTENT_TYPE_FORM);
    }

    public static String postJson(String url,Map<String,Object> params ){
        return request(url,"POST",params,null,CONTENT_TYPE_JSON);
    }

    public static String post(String url,Map<String,Object> params,Map<String,String> headers, String contentType){
        return request(url,"POST",params,headers,contentType);
    }

    public static String request(String url,String method,Map<String,Object> params,Map<String,String> headers,String contentType) {
